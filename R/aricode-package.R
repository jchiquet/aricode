...
#' measures. Most of the available measures are described in the paper of Vinh
#' et al, JMLR, 2009 (see reference below).
#'
...
#' * MARI: computes the modified adjusted rand index (Sundqvist et al, 2023)
...
#' @references
#'  * Nguyen Xuan Vinh, Julien Epps, and James Bailey. "Information theoretic
#'  measures for clusterings comparison: Variants, properties, normalization
#'  and correction for chance." Journal of Machine Learning Research 11.Oct
#'  (2010): 2837-2854. as described in Vinh et al (2009)
#'  * Sundqvist, Martina, Julien Chiquet, and Guillem Rigaill. "Adjusting the
#'  adjusted Rand Index: A multinomial story." Computational Statistics 38.1
#'  (2023): 327-347.
#' @seealso \code{\link{ARI}}, \code{\link{RI}}, \code{\link{NID}},
#'  \code{\link{NVI}}, \code{\link{AMI}}, \code{\link{NMI}},
#'  \code{\link{entropy}}, \code{\link{clustComp}}
