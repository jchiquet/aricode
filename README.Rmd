...
In **aricode** we propose an implementation, based on counting sort, that is in $\Theta(n)$ in time and space.  Our
implementation of the ARI for instance is one or two order of magnitude faster than some standard implementation in `R`.
